...
TEST_CASE("Entities ECS Test") {
    ...
    SUBCASE("Create entity with components") {
        ...
        entities.CreateEntity().WithComponent<Position>(pos).WithComponent<Velocity>(Velocity(3.0f, 4.0f));
    ...
    SUBCASE("Entity map updates") {
        ...
        entities.CreateEntity().WithComponent<Velocity>(Velocity(1.0f, 2.0f));
    ...
    SUBCASE("Created entities are inserted into delete space") {
        ...
        entities.CreateEntity().WithComponent<Position>(Position(0.0f, 0.0f));
        entities.CreateEntity().WithComponent<Position>(Position(1.0f, 1.0f));

        entities.DeleteEntity(0);

        entities.CreateEntity().WithComponent<Velocity>(Velocity(2.0f, 2.0f));

        CHECK(entities.GetLastCreatedEntity() == 0);

        entities.CreateEntity().WithComponent<Velocity>(Velocity(3.0f, 3.0f));
