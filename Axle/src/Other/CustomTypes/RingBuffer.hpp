...
namespace Axle {
    /**
     * Fairly basic multiple producer, single consumer lock-free RingBuffer inspired on David Álvarez Rosa
     * implementation: https://david.alvarezrosa.com/posts/optimizing-a-lock-free-ring-buffer
     *
    ...
    private:
        // NOTE: We leave one slot permanently unused to distinguish “full” from “empty".
